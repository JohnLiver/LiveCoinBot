...
const tg = new Telegram.Telegram('6762465964:AAGnOb3GINg6VhiAgleaG-TCpGx8kSGgdZI')
// var https.get = require('https.get');
const https = require('https');


class StatsController extends TelegramBaseController {
    hashrateHandler($) {
        https.get('httpss://blockchain.info/stats?format=json', (error, response, body) =>
    ...
    allblocksHandler($) {
        https.get('httpss://blockexplorer.com/api/status?q=getBlockCount', (error, response, body) =>
    ...
    lastblockHandler($) {
        https.get('httpss://blockexplorer.com/api/status?q=getLastBlockHash', (error, response, body) =>
...
class MarketsController extends TelegramBaseController {
    btcusdHandler($) {
        https.get('httpss://api.bitfinex.com/v1/pubticker/btcusd.json', (error, response, body) =>
    ...
    btcgbpHandler($) {
        https.get('httpss://blockchain.info/ticker', (error, response, body) =>
    ...
    ethusdHandler($) {
        https.get('httpss://api.bitfinex.com/v1/pubticker/ethusd.json', (error, response, body) =>
    ...
    ltcusdHandler($) {
        https.get('httpss://api.bitfinex.com/v1/pubticker/ltcusd.json', (error, response, body) =>
...
class ChartsController extends TelegramBaseController {
    dailyHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=1&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
            filename: 'daily.png'
        })
    };
    ...
    alltimeHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
    ...
    monthlyHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=30&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
    ...
    quarterlyHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=120&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
    ...
    yearlyHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=360&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
            filename: 'yearly.png'
        })
    ...
    weeklyHandler($) {
        $.sendPhoto({
            url: 'https://bitcoincharts.com/charts/chart.png?width=1307&m=bitfinexUSD&SubmitButton=Draw&r=10&i=&c=0&s=&e=&Prev=&Next=&t=T&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&',
            filename: 'weekly.png'
        })
    ...
    hashchartHandler($) {
        $.sendPhoto({
            url: 'https://bitcoin.sipa.be/speed-lin-2k.png',
            filename: 'hash.png'
        })
    ...
    startHandler($) {
        $.runInlineMenu({
            ...
            menu: [
                ...
                {
                    text: '😺GitHub',
                    url: 'httpss://github.com/kamikazechaser/LiveCoinBot'
